...
const double fiducial_vertex[0][3] = { 0.5 * fiducial_x,  0.5 * fiducial_y, -0.5 * fiducial_z};
const double fiducial_vertex[1][3] = {-0.5 * fiducial_x,  0.5 * fiducial_y, -0.5 * fiducial_z};
const double fiducial_vertex[2][3] = { 0.5 * fiducial_x, -0.5 * fiducial_y, -0.5 * fiducial_z};
const double fiducial_vertex[3][3] = {-0.5 * fiducial_x, -0.5 * fiducial_y, -0.5 * fiducial_z};
const double fiducial_vertex[4][3] = { 0.5 * fiducial_x,  0.5 * fiducial_y,  0.5 * fiducial_z};
const double fiducial_vertex[5][3] = {-0.5 * fiducial_x,  0.5 * fiducial_y,  0.5 * fiducial_z};
const double fiducial_vertex[6][3] = { 0.5 * fiducial_x, -0.5 * fiducial_y,  0.5 * fiducial_z};
const double fiducial_vertex[7][3] = {-0.5 * fiducial_x, -0.5 * fiducial_y,  0.5 * fiducial_z};
...
const double rotated_fiducial_vertex[0][3] = { fiducial_vertex[0][0], cosine * fiducial_vertex[0][1] - sine * fiducial_vertex[0][2], sine * fiducial_vertex[0][1] + cosine * fiducial_vertex[0][2]};
const double rotated_fiducial_vertex[1][3] = { fiducial_vertex[1][0], cosine * fiducial_vertex[1][1] - sine * fiducial_vertex[1][2], sine * fiducial_vertex[1][1] + cosine * fiducial_vertex[1][2]};
